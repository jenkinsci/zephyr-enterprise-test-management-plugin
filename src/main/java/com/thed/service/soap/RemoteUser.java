 ...
 *         &lt;element name="remoteRole" type="{http://soap.service.thed.com/}remoteRole" maxOccurs="unbounded" minOccurs="0"/>
...
public class RemoteUser {
    ...
    /**
     * Gets the value of the remoteRole property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the remoteRole property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRemoteRole().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<RemoteRole> getRemoteRole() {
        if (remoteRole == null) {
            remoteRole = new ArrayList<RemoteRole>();
        }
